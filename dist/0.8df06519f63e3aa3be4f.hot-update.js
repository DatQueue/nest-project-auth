...
let AuthService = class AuthService {
    ...
    async refresh(refreshTokenDto) {
        ...
        const isRefreshTokenValid = await this.userService.isRefreshTokenValid(userId, refresh_token);
        if (!isRefreshTokenValid) {
            throw new common_1.UnauthorizedException('Refresh token is not valid');
        }
        const accessToken = this.jwtService.sign(Object.assign(Object.assign({}, decodedRefreshToken), { exp: Math.floor(Date.now() / 1000) + 20 }));
        return { accessToken };
    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("093dcb60d6e7c25c3383")
/******/ })();
/******/ 
/******/ }
;