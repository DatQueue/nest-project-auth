...
let UsersService = class UsersService {
    ...
    async getUserIfRefreshTokenMatches(refreshToken, payloadId) {
        const user = await this.findUserById(payloadId);
    ...
    async getUserByRefreshToken(refreshToken) {
        const user = await this.userRepository.findOne({
            where: {
                currentRefreshToken: await bcrypt.hash(refreshToken, 10)
            },
        });
        console.log(await bcrypt.hash(refreshToken, 10));
        return user;
    }
    getCookiesForLogOut() {
        return [
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("5ca8701f8d98403b5ab3")
/******/ })();
/******/ 
/******/ }
;