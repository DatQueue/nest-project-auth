...
const jwt_strategy_1 = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module './strategy/jwt.strategy'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
AuthModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [auth_service_1.AuthService, users_service_1.UsersService, jwt_strategy_1.JwtAccessStrategy, jwt_auth_guard_1.JwtAuthGuard],
    })
], AuthModule);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("b4867ba27285c3c4ebaf")
/******/ })();
/******/ 
/******/ }
;