...
let UsersService = class UsersService {
    ...
    async getUserByRefreshToken(refreshToken) {
        const user = await this.userRepository.findOne({
            where: {
                currentRefreshToken: await this.getCurrentRefreshToken(refreshToken),
            },
        });
        console.log(await this.getCurrentRefreshToken(refreshToken));
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("9ec127f1ec8f6485b425")
/******/ })();
/******/ 
/******/ }
;