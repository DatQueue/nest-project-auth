...
let AuthService = class AuthService {
    ...
    async validateRefreshToken(refreshTokenDto) {
        const user = await this.userService.getUserByRefreshToken(refreshTokenDto.refresh_token);
        if (!user) {
            throw new common_1.NotFoundException('dfsfd');
        }
        if (!await bcrypt.compare(refreshTokenDto.refresh_token, user.currentRefreshToken)) {
            throw new common_1.BadRequestException('Invalid credentials');
        }
        return user;
    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("955ff513c488264caf18")
/******/ })();
/******/ 
/******/ }
;