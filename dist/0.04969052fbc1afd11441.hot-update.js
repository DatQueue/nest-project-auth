    ...
    async canActivate(context) {
        try {
            ...
            if (expirationTime < currentTime) {
                const newAccessToken = await this.authService.refresh(refresh_token);
                response.setHeader('Authorization', 'Bearer ' + newAccessToken);
                return this.jwtService.verify(newAccessToken.accessToken) && true;
            }
            else {
                console.log("아직은 만료시간 안지남");
            }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("e5a390ca1e3f338108a9")
/******/ })();
/******/ 
/******/ }
;