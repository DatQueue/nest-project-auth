...
const payload_interface_1 = __webpack_require__(128);
let AuthController = class AuthController {
    ...
    async refresh(req, res, refreshTokenDto, payload) {
        return await this.authService.refresh(refreshTokenDto, payload);
    }
    async user(req, res) {
...
__decorate([
    ...
    __param(1, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, typeof (_o = typeof express_1.Response !== "undefined" && express_1.Response) === "function" ? _o : Object]),
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("40a598129cc7ea01f439")
/******/ })();
/******/ 
/******/ }
;