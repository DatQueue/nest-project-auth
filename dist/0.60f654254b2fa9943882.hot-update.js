...
let AuthService = class AuthService {
    ...
    async validateUser(loginDto) {
        ...
        if (!loginDto.password) {
            throw new common_1.BadRequestException('Please ');
        }
        if (!loginDto.password || !await bcrypt.compare(loginDto.password, user.password)) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("2c1168cf17b3dad8ad3e")
/******/ })();
/******/ 
/******/ }
;