...
const jwt_auth_guard_1 = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module './guard/jwt-auth.guard'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
AuthModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [auth_service_1.AuthService, users_service_1.UsersService, jwt_access_strategy_1.JwtAccessStrategy, jwt_auth_guard_1.JwtAuthGuard],
    })
], AuthModule);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("2ed3abf38f67c642ccf6")
/******/ })();
/******/ 
/******/ }
;